// Bourbonomics: Map Game — action deck (brief v3 §14c).
//
// 45 cards (6 suits × 5 designs, with copies). Each card carries `pips` and a
// bourbon-initiative `icon` (the last icon played takes the marker — §4). No
// numeric rank. Distill is breadth-2: Bid + Refresh. All values [PH].
...
const DECK: Record<Suit, CardSeed[]> = {
  DISTRIBUTION: [
    { name: "Route Expansion", pips: 4, icon: false, copies: 2 },
    { name: "Field Buildout", pips: 4, icon: false, copies: 2 },
    { name: "Shelf Placement", pips: 3, icon: false, copies: 2 },
  ...
  DISTILL: [
    { name: "Barrel Allocation", pips: 4, icon: false, copies: 2 },
    { name: "Private Pick", pips: 4, icon: false, copies: 1 },
    { name: "Single Barrel Program", pips: 3, icon: false, copies: 2 },
