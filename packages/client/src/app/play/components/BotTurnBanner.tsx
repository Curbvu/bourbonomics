...
export default function BotTurnBanner() {
  ...
  return (
    ...
    >
      <span className="flex items-center gap-2 rounded-full border border-amber-500/70 bg-gradient-to-b from-amber-900/85 to-slate-950/95 px-3.5 py-1.5 font-mono text-[13px] font-bold uppercase tracking-[.14em] text-amber-100 shadow-[0_4px_14px_rgba(0,0,0,.5),inset_0_1px_0_rgba(255,255,255,.08)] backdrop-blur-md">
