/**
 * WoW-style tier chrome for mash bills.
 *
 * Five tiers, canonical WoW palette:
 *   common      white / slate
 *   uncommon    green
 *   rare        blue
 *   epic        purple
 *   legendary   orange
 *
 * Centralised so MashBillCard (HandTray), MashBillTile (MarketCenter),
 * and any future inspect modal agree per tier on border, gradient,
 * label tint, and glow.
 */
...
export const TIER_CHROME: Record<MashBillTier, TierChrome> = {
  ...
  epic: {
    ...
    glow: "shadow-[0_0_24px_rgba(167,139,250,.40)] ring-2 ring-violet-400/40",
  ...
  legendary: {
    ...
    glow: "shadow-[0_0_32px_rgba(251,146,60,.55)] ring-2 ring-orange-400/55",
    pill: "border-orange-300 bg-gradient-to-b from-orange-300 to-orange-500 text-slate-950",
