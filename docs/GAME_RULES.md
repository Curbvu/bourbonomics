...
Market cards represent changes in the broader bourbon economy. They might increase or decrease demand, create shortages of certain resources, or temporarily affect rickhouses.
...
Rickhouses have limited space and are shared by all players. Once you place a barrel, it stays there permanently.

Because rent is based on the total number of barrels in a location, crowded rickhouses become expensive. Choosing where to store your bourbon is often just as important as when to sell it.
